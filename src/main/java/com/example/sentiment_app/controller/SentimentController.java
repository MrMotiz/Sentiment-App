...
import com.example.sentiment_app.service.UserServiceImp;
...
public class SentimentController {
    ...
    public SentimentController(UserServiceImp userServiceImp) {
    ...
    public ResponseEntity<?> createUser(@RequestBody CreateUserDto userDto, BindingResult bindingResult) {
        ...
        return new ResponseEntity<>(userServiceImp.createText(userDto), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<?> createText(@PathVariable Integer id, @RequestBody CreateTextDto textDto, BindingResult bindingResult) {
        ...
        return new ResponseEntity<>(userServiceImp.createText(id, textDto), HttpStatus.OK);
    }
